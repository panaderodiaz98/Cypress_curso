...
describe('Reserva de material seriado', () =>{
    /* before(()=>{
        /* Loguin Azure SSO 
        login_fsm.loginFSM()
    }) */
    ...
    it('Añadir materiales seriados', () =>{
        creacion_solcitud.agrego_material_seriado().click()
        creacion_solcitud.lupa_material_seriado().click()
        cy.wait(2000)
        creacion_solcitud.codigo_material().type("000000000000024993")
        creacion_solcitud.buscar_material().click()
        cy.wait(2000)
        movimientos_materiales.busco_tabla("000000000000024993",null,null,null).click()
        cy.wait(2000)
        creacion_solcitud.seleccionar_material().click()
        cy.wait(2000)
        creacion_solcitud.cantidad_material_seriado().type("1")
        creacion_solcitud.ok_material_seriado().click()
        cy.wait(2000)
    }
    );
